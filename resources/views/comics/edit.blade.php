        ...
        <form action="{{ route('comics.update', $comic->id) }}" method="POST">
            ...
            <div class="row mb-3">
                <div class="col-6">
                    ...
                    <input required name="title" value="{{ $comic->title }}" type="text" class="form-control @error('title') is-invalid @enderror" value="{{ old('title') }}" required min="3" maxlength="255" id="title">
